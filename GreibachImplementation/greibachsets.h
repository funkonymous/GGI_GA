...
{
public:
    GreibachSets();                                            // Dummy constructor
    GreibachSets(EnumTerminalsMap &m, size_t NtSize);          // Constructor of the sets boundaries
    ...
    void WriteLog(std::ofstream &f) const;                     // Write log files
private:
